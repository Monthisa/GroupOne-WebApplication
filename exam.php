...
<head>
	...
	<title>Book Store-แนวข้อสอบ PAT1 ความถนัดทางคณิตศาสตร์</title>
	<link href="style.css" rel="stylesheet" type="text/css" />
...
<div class="row">
  <div class="column cartoon">
    <div class="content">
      <img src="exambook.jpg" alt="exambook" style="width:100%" class="center"><br>
    </div>
  </div>
...
?>
  ...
  <div class="column2 novel">
    <form action="ViewCart.php?action=add&id=<?php echo $product_array[4]["id"]; ?>" method="post">
    <div class="content">
      <h2 style="font-family:'Mali', cursive;">แนวข้อสอบ PAT1 ความถนัดทางคณิตศาสตร์</h2>
      <h4><span><h5 class="homebook">(โดย รัชพล ธนาภากรรัตนกุล)</h5></span></h4>
      <p style="font-family:'Mali', cursive;">สำนักพิมพ์ : ศูนย์หนังสือจุฬา</p>
      <p style="font-family:'Mali', cursive;">เน้นการอธิบายเป็นขั้นเป็นตอนอย่างละเอียด ผู้อ่านจึงสามารถทำความเข้าใจได้ด้วยตัวเอง และนำไปใช้ในห้องสอบได้อย่างแท้จริง เมื่อผู้อ่านได้ศึกษาหนังสือเล่มนี้จนกระทั่งเข้าใจอย่างแท้จริง</p>
      <p style="font-family:'Mali', cursive;">ราคา : 200.00 บาท<br>
      ราคาส่วนลด : 170.00 บาท</p>
      <p style="font-family:'Mali', cursive;">หมวด : หนังสือเตรียมสอบ</p>
    </div>
    <div>
