...
<head>
	...
	<title>Book Store-มหาศึกคนชนเทพ เล่ม 1 (Mg)</title>
	<link href="style.css" rel="stylesheet" type="text/css" />
...
<div class="row">
  <div class="column cartoon">
    <div class="content">
      <img src="cartoon.jpg" alt="cartoon" style="width:100%" class="center"><br>
    </div>
  </div>
...
?>
  ...
  <div class="column2 novel">
    <form action="ViewCart.php?action=add&id=<?php echo $product_array[0]["id"]; ?>" method="post">
    <div class="content">
      <h2 style="font-family:'Mali', cursive;">มหาศึกคนชนเทพ เล่ม 1 (Mg)</h2>
      <h4><span><h5 class="homebook">(โดย เทียนฉิน)</h5></span></h4>
      <p style="font-family:'Mali', cursive;">สำนักพิมพ์ : PHOENIX-ฟีนิกซ์</p>
      <p style="font-family:'Mali', cursive;">โดยการเผชิญหน้ากับ 13 เทพที่แข็งแกร่งที่สุดในสวรรค์สงครามที่เดิมพันด้วยความเป็นความตายของมนุษย์กำลังจะเริ่มต้นขึ้น ณ บัดนี้</p>
      <p style="font-family:'Mali', cursive;">ราคา : 145.00 บาท<br>
