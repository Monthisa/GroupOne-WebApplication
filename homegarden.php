...
<head>
	...
	<title>Book Store-Unique Homes</title>
	<link href="style.css" rel="stylesheet" type="text/css" />
...
<div class="row">
  <div class="column cartoon">
    <div class="content">
      <img src="hng.jpg" alt="hng" style="width:100%" class="center"><br>
    </div>
  </div>
...
?>
  ...
  <div class="column2 novel">
    <form action="ViewCart.php?action=add&id=<?php echo $product_array[3]["id"]; ?>" method="post">
    <div class="content">
      <h2 style="font-family:'Mali', cursive;">Unique Homes</h2>
      <h4><span><h5 style="font-family:'Mali', cursive;">(โดย ภัทริน จิตรกร)</h5></span></h4>
      <p style="font-family:'Mali', cursive;">สำนักพิมพ์ : บ้านและสวน</p>
      <p style="font-family:'Mali', cursive;">รวบรวมงานออกแบบและบ้านที่ตกแต่งด้วยการผสมผสานตามความรู้สึกพึงพอใจ ไร้กฏเกณฑ์อย่างไม่มีขีดจำกัด เป็นไปตามรสนิยมและไลฟ์สไตล์ จนอาจไม่สามารถระบุสไตล์การตกแต่งได้อย่างเฉพาะเจาะจง เมื่อกระแสไม่ใช่เรื่องจำเป็นอีกต่อไป เราจึงเชื่อว่าการผสมผสานเพื่อให้ได้ที่อยู่อาศัยที่บ่งบอกความเป็นตัวของเราเองมากที่สุดดังตัวอย่างที่หยิบยกขึ้นมานี้เป็นแนวทางการตกแต่งแห่งยุคปัจจุบัน </p>
      <p style="font-family:'Mali', cursive;">ราคา : 395.00 บาท<br>
      ราคาส่วนลด : 197.50 บาท</p>
      <p style="font-family:'Mali', cursive;">หมวด : บ้านและสวน</p>
    </div>
    <div>
