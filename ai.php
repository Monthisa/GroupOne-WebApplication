...
<head>
	...
	<title>Book Store-การปฏิวัติคอนเทนต์ในยุคแห่ง AI</title>
...
<div class="row">
  <div class="column cartoon">
    <div class="content">
      <img src="ai.jpg" alt="AI" style="width:100%" class="center"><br>
    </div>
  </div>
  <?php     
  ...
  <div class="column2 novel">
    <form action="ViewCart.php?action=add&id=<?php echo $product_array[2]["id"]; ?>" method="post">
    <div class="content">
      <h2 style="font-family:'Mali', cursive;">การปฏิวัติคอนเทนต์ในยุคแห่ง AI</h2>
      <h4><span><h5 class="homebook">(โดย Cho Chan-soo)</h5></span></h4>
      <p style="font-family:'Mali', cursive;">สำนักพิมพ์ : อมรินทร์ How to</p>
      <p style="font-family:'Mali', cursive;">งานของคุณอาจหายไปเมื่อ AI ทำงานที่ใช้ความคิดสร้างสรรค์ได้เหมือนมนุษย์คนที่ปรับตัวและทำงานร่วมกับ AI เท่านั้นถึงจะอยู่รอด</p>
      <p style="font-family:'Mali', cursive;">ราคา : 275.00 บาท<br>
      ราคาส่วนลด : 233.75 บาท</p>
      <p style="font-family:'Mali', cursive;">หมวด : บริหาร ธุรกิจ</p>
    </div>
    
    <div>
      <div class="cart-action"><input type="text" class="product-quantity" name="quantity" value="1" size="2" />
      <input type="submit" value="Add to Cart" class="btnAddAction" id="cart" /></div>
    </div>
    </form>
  </div>
</div>
